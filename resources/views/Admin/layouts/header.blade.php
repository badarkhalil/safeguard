    ...
    <div class="dt-header__container">
      ...
      <div class="dt-brand">
        ...
        <a class="dt-brand__logo-link" href="/">
          <img class="dt-brand__logo d-lg-inline-block" style="width:60px;" src="{{ asset('admin/node_modules/ammap3/images/logo.jpeg') }}" alt="Wieldy">
          <img class="dt-brand__logo-symbol d-lg-none" style="width:60px;" src="{{ asset('admin/node_modules/ammap3/images/logo.jpeg') }}" alt="Wieldy">
        </a>
      </span>
        <!-- /brand logo -->
                ...
                <div class="dropdown-menu-body ps-custom-scrollbar">
                  ...
                  <div class="h-auto">
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="{{ asset('admin/node_modules/ammap3/images/logo.png') }}" alt="User">
                      <!-- avatar -->
          ...
          <ul class="dt-nav d-lg-none">
            <li class="dt-nav__item dropdown">
              ...
              <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                ...
                <img class="dt-avatar size-40" src="" alt="Domnic Harris">
              </a>
              <!-- /dropdown link -->
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <div class="dt-avatar-wrapper flex-nowrap p-6 mt--5 bg-gradient-purple text-white rounded-top">
                  <img class="dt-avatar" src="" alt="{{ Auth::user()->name }}">
